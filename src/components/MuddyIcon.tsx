const MuddyIcon = () => (
  <div class="flex justify-center items-center" title="It's gonna be muddy">
    <svg
      class="h-40 fill-black dark:fill-gray-100"
      aria-label="Muddy Weather Icon"
      aria-description="It's gonna be muddy"
